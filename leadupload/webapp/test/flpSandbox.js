		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Efficient Lead upload",
									"targetURL": "#comsapbmizc4cui5leadupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapbmizc4cui5leadupload-display": {
								"semanticObject": "comsapbmizc4cui5leadupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.bmi.zc4cui5leadupload",
									"url": sap.ui.require.toUrl("com/sap/bmi/zc4cui5leadupload")
								}
							}
						}
					}
